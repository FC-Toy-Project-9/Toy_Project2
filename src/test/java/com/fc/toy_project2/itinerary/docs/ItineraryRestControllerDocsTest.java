...
//        itinerarySearchList.add(SearchResponseDTO.builder().placeName("카카오프렌즈 스크린골프 만성점")
//            .roadAddressName("전북 전주시 덕진구 만성중앙로 53-46")
//            .placeUrl("http://place.map.kakao.com/1480405278").build());
//        itinerarySearchList.add(SearchResponseDTO.builder().placeName("양지카카오 프렌즈 스크린골프")
...
//                        fieldWithPath("data[].checkIn").type(JsonFieldType.ARRAY).optional()
//                            .description("체크인 일시"),
//                        fieldWithPath("data[].checkOut").type(JsonFieldType.ARRAY).optional()
//                            .description("체크아웃 일시"),
...
//                        fieldWithPath("data[].departureTime").type(JsonFieldType.ARRAY).optional()
//                            .description("출발 일시"),
//                        fieldWithPath("data[].arrivalTime").type(JsonFieldType.ARRAY).optional()
//                            .description("도착 일시"),
...
//                            .optional()
//                            .description("장소 도로명"),
//                        fieldWithPath("data[].visitDepartureTime").type(JsonFieldType.ARRAY)
//                            .optional()
//                            .description("도착 일시"),
//                        fieldWithPath("data[].visitArrivalTime").type(JsonFieldType.ARRAY)
//                            .optional()
//                            .description("출발 일시"))));
//
//    }
